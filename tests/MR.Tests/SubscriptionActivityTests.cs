...
/// <para>
/// Written before the behaviour moves, per P13. <c>MrUserService.HasActiveSubscriptionAsync</c>
...
public class SubscriptionActivityTests
{
    ...
    {
        // MrUserService returns `subscription?.IsActive() ?? false`. The old implementation
