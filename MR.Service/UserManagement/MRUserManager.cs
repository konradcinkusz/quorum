...
/// subscription check — now lives in <see cref="IMrUserService"/>, which has no dependency on
...
public class MRUserManager : UserManager<ApplicationUser>
{
    ...
    public MRUserManager(IMrUserService users, IUserStore<ApplicationUser> store, IOptions<IdentityOptions> optionsAccessor,
