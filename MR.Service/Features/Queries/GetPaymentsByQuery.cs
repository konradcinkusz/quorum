...
public class GetPaymentsByQuery : IRequest<IEnumerable<Payment>>
{
    ...
    public class GetPaymentsByQueryHandler : IRequestHandler<GetPaymentsByQuery, IEnumerable<Payment>>
    {
        private readonly IApplicationDbContext _context;

        public GetPaymentsByQueryHandler(IApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<IEnumerable<Payment>> Handle(GetPaymentsByQuery request, CancellationToken cancellationToken)
        {
