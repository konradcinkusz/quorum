...
| D7 | **`iTextSharp` 5.x is AGPL, in an MIT repository that ships a container image** | Also .NET Framework-era and it drags in a vulnerable BouncyCastle (F14). | Decided in [ADR 0002](0002-pdf-generation.md) — PDFsharp + MigraDoc, MIT. [#21](https://github.com/konradcinkusz/quorum/issues/21) implements it. |
